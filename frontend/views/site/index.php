                        ...
                        <div class="row justify-content-sm-center justify-content-xl-start">
                            <div class="col-lg-9 text-lg-left col-sm-10">
                                ...
                                <div class="offset-top-20 offset-xl-top-40" data-caption-animate="fadeInUp"
                                     data-caption-delay="400"><a class="btn button-primary" href="apply.html">Apply Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row row-50 text-md-left align-items-md-center justify-content-md-between">
            ...
            <div class="col-md-7 col-lg-7 order-md-1">
                ...
                <div class="offset-top-35 offset-lg-top-60">
                    <p>One of the world's premier academic and research institutions, the Lead International University has
                        driven new ways of thinking since our 1876 founding. Today, JCU is an intellectual destination that
                        draws inspired scholars to our Hyde Park and international campuses, keeping JCU at the nexus of ideas
                        that challenge and change the world.</p>
                </div>
                <div class="offset-top-30"><a class="btn btn-icon btn-icon-right button-default" href="history.html"><span
                ...
                <div class="section-image-aside-body section-xl inset-md-left-70 inset-xl-left-110">
                    ...
                    <div class="text-left">
                        <div class="offset-top-60">
                            <article class="post-vacation"><a class="post-vacation-img-wrap bg-image" href="academics.html"
                                                              style="background-image: url(<?= $toImages. '/course-01-150x120.jpg' ?>)"></a>
                                <div class="post-vacation-body">
                                    <div>
                                        <h6 class="post-vacation-title"><a href="academics.html">Financial Analyst Course</a></h6>
                                    </div>
                        ...
                        <div class="offset-top-30">
                            <article class="post-vacation"><a class="post-vacation-img-wrap bg-image" href="academics.html"
                                ...
                                <div class="post-vacation-body">
                                    <div>
                                        <h6 class="post-vacation-title"><a href="academics.html">Digital Marketing Course</a></h6>
                                    </div>
                                    <div class="offset-lg-top-10">
                                        <p>Maria Howard</p>
                                    </div>
                        ...
                        <div class="offset-top-30">
                            <article class="post-vacation"><a class="post-vacation-img-wrap bg-image" href="academics.html"
                                ...
                                <div class="post-vacation-body">
                                    <div>
                                        <h6 class="post-vacation-title"><a href="academics.html">Graphic Design Course</a></h6>
                                    </div>
                                    <div class="offset-lg-top-10">
                                        <p>Steven Carter</p>
                                    </div>
        ...
        <div class="row justify-content-sm-center offset-top-60">
            <div class="col-sm-10 col-md-8">
                <p>Lead International University was founded on the principle that by pursuing big ideas and sharing what we
                    learn, we make the world a better place. For more than 135 years, we haven’t strayed from that vision.</p>
            </div>
        </div>
...
<section class="section bg-catskill section-xl">
    <div class="container container-wide">
            ...
            <div class="col-md-6 col-lg-5 col-xxl-3">
                <article class="post-event">
                    <div class="post-event-img-overlay"><img class="img-responsive" src="<?= $toImages. '/blog/events-03-420x420.jpg' ?>"
                        ...
                        <div class="post-event-overlay context-dark"><a class="btn button-primary" href="apply.html">Book
                                Now</a>
        ...
        <div class="offset-top-50 offset-lg-top-56"><a class="btn btn-icon btn-icon-right button-primary"
                                                       href="calendar.html"><span class="icon fa fa-arrow-right"></span><span>View Event Calendar</span></a></div>
    </div>
</section>
<!-- Testimonials-->
    ...
    <div class="owl-carousel owl-carousel-default owl-carousel-nav-xl" data-items="1" data-nav="true" data-dots="true"
            ...
            <div class="container section-70 section-xl-100 section-xl-bottom-114">
                <div class="row justify-content-sm-center align-items-sm-center">
                    <div class="col-md-3 text-md-right order-md-2"><img class="img-responsive d-inline-block rounded-circle"
                                                                        src="<?= $toImages. '/users/user-debra-banks-230x230.jpg' ?>" width="230" height="230" alt=""></div>
                    <div class="col-md-9 order-md-1">
                        <div class="quote-classic-boxed text-left">
                            <div class="quote-body">
                                <q>When you work full-time while studying, you need to sacrifice personal time, which meant that I
                                    took my studies seriously. My ambition was not only to complete my degree successfully but to make
                                    the best out of the time spent studying.</q>
                                <div class="offset-top-30 text-right">
                                    <cite class="font-accent">Debra Banks</cite>
                                    <div class="offset-top-5">
                                        <p class="text-dark font-italic">Diploma for Graduates in Management, USA</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div>
            <div class="container section-70 section-xl-100 section-xl-bottom-114">
                <div class="row justify-content-sm-center align-items-sm-center">
                    <div class="col-md-3 text-md-right order-md-2"><img class="img-responsive d-inline-block rounded-circle"
                                                                        src="<?= $toImages. '/users/user-steven-alvarez-230x230.jpg' ?>" width="230" height="230" alt=""></div>
                    <div class="col-md-9 order-md-1">
                        <div class="quote-classic-boxed text-left">
                            <div class="quote-body">
                                <q>When I researched the programmes available I realized that the University was offering exactly
                                    the type of programme in international development that interested me.</q>
                                <div class="offset-top-30 text-right">
                                    <cite class="font-accent">Steven Alvarez</cite>
                                    <div class="offset-top-5">
                                        <p class="text-dark font-italic">Diploma for Graduates in International Development, USA</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row row-30 offset-top-60 text-left justify-content-sm-center">
            <div class="col-md-6 col-lg-4">
                <article class="post-news"><a href="news-post.html"><img class="img-responsive"
                                                                         src="<?= $toImages. '/blog/news-04-370x240.jpg' ?>" width="370" height="240" alt=""></a>
                    <div class="post-news-body">
                        <h6><a href="news-post.html">
            ...
            <div class="col-md-6 col-lg-4">
                <article class="post-news"><a href="news-post.html"><img class="img-responsive"
                    ...
                    <div class="post-news-body">
                        <h6><a href="news-post.html">Studying in the United States</a></h6>
                        <div class="offset-top-20">
